...
public class Main_Seba_with_Improvements {
	...
	public static void main(String[] args) throws IOException, InterruptedException, ParseException {
		...
		TestCoverageComputation testCoverageComputation = new TestCoverageComputation(productionClass, testClass, classesFiles, testsFiles, pBinFolder);
	 ...
	 * @throws IOException
	 */
	public static String generateTestCaseDescription(MethodBean testCase,ClassBean originalClass, ClassBean executedClass,List<String> textContentExecutedOriginalClass, double attributesTested) throws IOException, InterruptedException
	{
		//initialization
		String description2="*";
		String line="",level="";
